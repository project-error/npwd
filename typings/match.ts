...
export enum MatchEvents {
  ...
  MATCH_CREATE_MY_PROFILE = 'phone:createMyProfile',
  MATCH_CREATE_MY_PROFILE_SUCCESS = 'phone:createMyProfileSuccess',
  MATCH_CREATE_MY_PROFILE_FAILED = 'phone:createMyProfileFailed',
