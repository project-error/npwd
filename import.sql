...
(
    ...
    CONSTRAINT `darkchat_channel_members_darkchat_channels_id_fk` FOREIGN KEY (`channel_id`) REFERENCES `npwd-server`.`darkchat_channels` (`id`) ON UPDATE RESTRICT ON DELETE RESTRICT
)
    COLLATE = 'utf8mb4_general_ci'
    ENGINE = InnoDB
;
...
(
    ...
    CONSTRAINT `darkchat_messages_darkchat_channels_id_fk` FOREIGN KEY (`channel_id`) REFERENCES `npwd-server`.`darkchat_channels` (`id`) ON UPDATE RESTRICT ON DELETE RESTRICT
)
    COLLATE = 'utf8mb4_general_ci'
    ENGINE = InnoDB
;
