...
RegisterNuiProxy(MarketplaceEvents.EDIT_LISTING);
...
onNet(MarketplaceEvents.BROADCAST_EDIT, (broadcastEvent: MarketplaceBroadcastEditDTO) => {
  sendMarketplaceEvent(MarketplaceEvents.BROADCAST_EDIT, broadcastEvent);
});
