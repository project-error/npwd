export default {
  ...
  TWITTER_GET_OR_CREATE_PROFILE_NULL: 'getOrCreateTwitterProfileNull',
  TWITTER_GET_OR_CREATE_PROFILE_FAILURE: 'getOrCreateTwitterProfileFailed',
  TWITTER_CREATE_PROFILE: 'phone:createTwitterProfile',
  TWITTER_CREATE_PROFILE_RESULT: 'phone:createProfileResult',
